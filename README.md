...
## 📌 Đọc trước — câu trả lời cho yêu cầu điều tra

| Tài liệu | Là gì |
|---|---|
| **[BAO_CAO_DIEU_TRA.md](BAO_CAO_DIEU_TRA.md)** | **Câu trả lời chính (1–2 trang):** Jira API cần dùng + 3 hướng triển khai + hướng đề xuất. **Đọc cái này trước.** |
| [DANH_GIA_NATIVE_JSM_AI.md](DANH_GIA_NATIVE_JSM_AI.md) | JSM đã có sẵn ~80% use case — đánh giá native trước khi cân nhắc tự xây. |
| [API_GUIDE.md](API_GUIDE.md) | Chi tiết vai trò 52 API cho AI. |
| [phase2_enterprise/](phase2_enterprise/) | Bộ thiết kế enterprise — chỉ đọc khi đã quyết định làm thật. |

> Web demo + Postman bên dưới là **công cụ minh hoạ thêm** (yêu cầu gốc "không cần demo") — tiện cho team AI thử API, không bắt buộc.

## Web có gì — công cụ minh hoạ tương tác
